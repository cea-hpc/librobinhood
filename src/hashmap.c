 ...
 * slot and be done with it. We have to maintain the invariant, which means
 ...
 * have to enforce the invariant again.
 *
 * To the question:
 *     When would a cell better be placed in a slot we are emptying?
 *
 * The answer is:
