                  ...
                  const struct rbh_statx *statxbuf)
{
    ...
    return (statxbuf->stx_mask & RBH_STATX_BLKSIZE ?
        ...
        && (statxbuf->stx_mask & RBH_STATX_ATIME ?
                BSON_APPEND_DOCUMENT_BEGIN(document, statx2str(RBH_STATX_ATIME),
                                           &subdoc)
...
/* TODO: do not use the dot notation is we want to override the xattrs */
static bool
